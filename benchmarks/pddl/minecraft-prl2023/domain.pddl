(define (domain minecraft-contrived3-cam)
    ...
    (:action pickup-stick
        :parameters ( ?ag - agent ?i - stick ?n_start - count ?n_end - count ?x - position ?y - position ?z - position
        )
        :precondition (and
            (present ?i)
            ; (= (x ?i) (x ?ag))
    ...
    (:action pickup-diamond-axe
        :parameters ( ?ag - agent ?i - diamond-axe ?n_start - count ?n_end - count ?x - position ?y - position ?z - position
        )
        :precondition (and
            (present ?i)
            ; (= (x ?i) (x ?ag))
    ...
    (:action pickup-blue-dye
        :parameters ( ?ag - agent ?i - blue-dye ?n_start - count ?n_end - count ?x - position ?y - position ?z - position
        )
        :precondition (and
            (present ?i)
            ; (= (x ?i) (x ?ag))
    ...
    (:action drop-diamond
        :parameters ( ?ag - agent ?i - diamond ?n_start - count ?n_end - count ?x - position ?y_start - position ?y_end - position ?z - position
        )
        :precondition (and
    ...
    (:action drop-stick
        :parameters ( ?ag - agent ?i - stick ?n_start - count ?n_end - count ?x - position ?y_start - position ?y_end - position ?z - position
        )
        :precondition (and
    ...
    (:action drop-blue-dye
        :parameters ( ?ag - agent ?i - blue-dye ?n_start - count ?n_end - count ?x - position ?y_start - position ?y_end - position ?z - position
        )
        :precondition (and
    ...
    (:action drop-wooden-block
        :parameters ( ?ag - agent ?b - wooden-block ?n_start - count ?n_end - count ?x - position ?y_start - position ?y_end - position ?z - position
        )
        :precondition (and
    ...
    (:action drop-wooden-planks
        :parameters ( ?ag - agent ?b - wooden-planks ?n_start - count ?n_end - count ?x - position ?y_start - position ?y_end - position ?z - position
        )
        :precondition (and
    ...
    (:action drop-wool-block
        :parameters ( ?ag - agent ?b - wool-block ?n_start - count ?n_end - count ?x - position ?y_start - position ?y_end - position ?z - position
        )
        :precondition (and
    ...
    (:action drop-bed
        :parameters ( ?ag - agent ?b - bed ?n_start - count ?n_end - count ?x - position ?y_start - position ?y_end - position ?z - position
        )
        :precondition (and
            ; (>= (agent-num-bed ?ag) 1)
    ...
    (:action apply-blue-dye
        :parameters ( ?ag - agent ?woolb - wool-block ?n_wool_start - count ?n_dye_start - count ?n_dye_end - count ?color_start - color ?color_end - color
        )
        :precondition (and
    ...
    (:action craft-bed-blue-dye
        :parameters ( ?ag - agent ?woolb1 - wool-block ?woolb2 - wool-block ?woolb3 - wool-block ?color - color ?bd - bed ?n_wool_start - count ?n_wool_end - count ?n_planks_start - count ?n_planks_end - count ?n_beds_start - count ?n_beds_end - count
        )
        :precondition (and
            ...
            (agent-has-n-wool-blocks ?ag ?n_wool_start)
            (exists
                (?n_wool_minus_one - count)
                (exists
                    (?n_wool_minus_two - count)
                    (and
            ...
            (exists
                (?n_planks_minus_one - count)
                (exists
                    (?n_planks_minus_two - count)
                    (and
    ...
    (:action craft-diamond-axe
        :parameters ( ?ag - agent ?n_sticks_start - count ?n_sticks_end - count ?n_diamonds_start - count ?n_diamonds_end - count ?n_diamond_axes_start - count ?n_diamond_axes_end - count
        )
        :precondition (and
            ; (>= (agent-num-stick ?ag) 2)
            (agent-has-n-sticks ?ag ?n_sticks_start)
            (exists
                (?n_sticks_minus_one - count)
                (exists
                    (?n_sticks_minus_two - count)
                    (and
            ...
            (exists
                (?n_diamonds_minus_one - count)
                (exists
                    (?n_diamonds_minus_two - count)
                    (and
    ...
    (:action craft-wooden-planks
        :parameters ( ?ag - agent ?wb - wooden-block ?n_blocks_start - count ?n_blocks_end - count ?n_planks_start - count ?n_planks_end - count
        )
        :precondition (and
    ...
    (:action craft-blue-dye
        :parameters ( ?ag - agent ?n_flowers_start - count ?n_flowers_end - count ?n_dye_start - count ?n_dye_end - count
        )
        :precondition ( and
    ...
    (:action hit-wooden-block
        :parameters ( ?ag - agent ?b - wooden-block ?x - position ?y_ag - position ?y_bl - position ?z - position ?n_hits_start - count ?n_hits_end - count ?n_axes - count
        )
        :precondition (and
            ; (= (x ?b) (x ?ag))
            ; (= (y ?b) (+ (y ?ag) 1))
            ...
            (exists
                (?n_axes_minus_one)
                (are-seq ?n_axes_minus_one ?n_axes))
        )
        :effect (and
    ...
    (:action destroy-wooden-block
        :parameters ( ?ag - agent ?b - wooden-block ?x - position ?y_ag - position ?y_bl - position ?z - position ?n_blocks_start - count ?n_blocks_end - count ?n_hits_start - count ?n_hits_end - count ?n_axes - count
        )
        :precondition (and
            ; (= (x ?b) (x ?ag))
            ; (= (y ?b) (+ (y ?ag) 1))
    ...
    (:action hit-wooden-planks
        :parameters ( ?ag - agent ?b - wooden-planks ?x - position ?y_ag - position ?y_bl - position ?z - position ?n_hits_start - count ?n_hits_end - count ?n_axes - count
        )
        :precondition (and
            ; (= (x ?b) (x ?ag))
            ; (= (y ?b) (+ (y ?ag) 1))
    ...
    (:action destroy-wooden-planks
        :parameters ( ?ag - agent ?b - wooden-planks ?x - position ?y_ag - position ?y_bl - position ?z - position ?n_planks_start - count ?n_planks_end - count ?n_hits_start - count ?n_hits_end - count ?n_axes - count
        )
        :precondition (and
            ; (= (x ?b) (x ?ag))
            ; (= (y ?b) (+ (y ?ag) 1))
    ...
    (:action hit-bed
        :parameters ( ?ag - agent ?b - bed ?x - position ?y_ag - position ?y_bl - position ?z - position ?n_hits_start - count ?n_hits_end - count ?n_axes - count
        )
        :precondition (and
            ; (= (x ?b) (x ?ag))
            ; (= (y ?b) (+ (y ?ag) 1))
    ...
    (:action destroy-bed
        :parameters ( ?ag - agent ?b - bed ?x - position ?y_ag - position ?y_bl - position ?z - position ?n_beds_start - count ?n_beds_end - count ?n_hits_start - count ?n_hits_end - count ?n_axes - count
        )
        :precondition (and
            ; (= (x ?b) (x ?ag))
            ; (= (y ?b) (+ (y ?ag) 1))
    ...
    (:action destroy-orchid-flower
        :parameters ( ?ag - agent ?b - orchid-flower ?x - position ?y_ag - position ?y_bl - position ?z - position ?n_start - count ?n_end - count
        )
        :precondition (and
            ; (= (x ?b) (x ?ag))
            ; (= (y ?b) (+ (y ?ag) 1))
    ...
    (:action destroy-oak-sapling
        :parameters ( ?ag - agent ?b - oak-sapling ?x - position ?y_ag - position ?y_bl - position ?z - position ?n_start - count ?n_end - count
        )
        :precondition (and
            ; (= (x ?b) (x ?ag))
            ; (= (y ?b) (+ (y ?ag) 1))
    ...
    (:action destroy-birch-sapling
        :parameters ( ?ag - agent ?b - birch-sapling ?x - position ?y_ag - position ?y_bl - position ?z - position ?n_start - count ?n_end - count
        )
        :precondition (and
            ; (= (x ?b) (x ?ag))
            ; (= (y ?b) (+ (y ?ag) 1))
