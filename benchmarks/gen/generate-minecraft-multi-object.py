...
def generate_problem(n_ag, n_int):
    sections = [f"(define (problem minecraft-multi-object-{n_ag:02d}-{n_int:02d})"]
    sections += [tab() + "(:domain minecraft-multi-object)"]
...
# %% generate sas
sas_dir = "../../benchmarks/sas/basic/minecraft-multi-object/"
