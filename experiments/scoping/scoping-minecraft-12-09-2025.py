...
BENCHMARKS_DIR = os.path.expanduser("~") + "/dev/downward/benchmarks/"
...
SUITE = ["minecraft/problems/hunger", "minecraft/problems/craft"]
...
exp.set_property("planner_time_limit", 300)  # pass this to executable
...
# Add this after your ops plots loop
for i, p in enumerate(alg_pairs):
