...
DEFAULT_OPTIMAL_SUITE_DBG = [
    'airport', 'barman-opt11-strips', 'blocks',
...
DEFAULT_OPTIMAL_SUITE_MINI = [
    'airport-mini', 'barman-opt11-strips-mini', 'blocks-mini',
    'data-network-opt18-strips-mini', 'depot-mini', 'driverlog-mini',
    'elevators-opt08-strips-mini', 'floortile-opt11-strips-mini',
    'ged-opt14-strips-mini', 'grid-mini', 'gripper-mini',
    'logistics00-mini', 'miconic-mini']
...
class IssueExperiment(FastDownwardExperiment):
    ...
    def add_algorithm(
        ...
        algorithm = _DownwardAlgorithm(
            name,
            CachedFastDownwardRevision(revision_cache=self.revision_cache, repo=repo, rev=rev, build_options=build_options),
            driver_options,
            component_options,
        )
